...
public class Box2dLightCustomShaderTest extends InputAdapter implements ApplicationListener {
    ...
    ArrayList<Body> balls = new ArrayList<Body>(NUM_BALLS);
    ...
    public void create() {
        ...
        TextureRegion marbleD = new TextureRegion(new Texture(Gdx.files.internal("test/data/marble.png")));

        TextureRegion marbleN = new TextureRegion(new Texture(Gdx.files.internal("test/data/marble-n.png")));
